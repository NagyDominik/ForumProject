...
describe('ForumpostsService', () => {
  ...
  describe('createPost', () => {
    ...
    it('should upload image if there is one ', () => {
      ...
      service.createPostWithImage({ id: 'asdasd', postDate: 'asdasdas', title: 'asd', description: 'description' }, tempFile).subscribe();
  ...
  describe('deletePost', () => {
    it('should be called once ', () => {
      firestoreDocMock.get.and.returnValue(helper.getSnapshotChangeDocChangeActions(1));
    ...
    it('should call firestore collection delete once', () => {
      ...
      firestoreDocMock.delete.and.returnValue(helper.getForumpostDocSnapshot(1));
